...
const DEFEAT_MESSAGES: Record<number, { title: string; flavor: string }> = {
  1: {
    ...
    flavor: 'The monsters of Kokiri Forest were too strong. Train harder, young hero!',
  },
  2: {
    title: 'The Temple Remains Unconquered...',
    flavor: 'The ancient puzzles proved too difficult. Study your times tables!',
  },
  3: {
    title: 'The Final Dungeon Prevails...',
    flavor: 'Ganon laughs at your defeat. But a true hero never gives up!',
  },
};
...
export function LevelFailed() {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(180deg, oklch(0.18 0.05 30) 0%, oklch(0.12 0.04 25) 40%, oklch(0.08 0.03 20) 100%)',
      }}
    >
      <div className="w-full max-w-lg animate-fade-in-scale">
        <ZeldaPanel className="p-8 text-center">
          ...
          >
            <p className="font-im-fell italic text-sm opacity-80">{info.flavor}</p>
          </div>
            ...
            <div className="flex justify-center gap-1 mt-3">
              {Array.from({ length: 10 }).map((_, i) => (
                <div
                  ...
                  style={{
                    background: i < score ? 'oklch(0.55 0.22 25)' : 'oklch(0.45 0.2 25 / 0.2)',
                    borderColor: 'oklch(0.45 0.2 25 / 0.5)',
                  }}
                />
              ))}
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={() => navigate({ to: '/level/$levelId', params: { levelId: String(level) } })}
