...
export class Backend implements backendInterface {
    ...
    async getUnlockedLevels(): Promise<LevelState> {
        if (this.processError) {
            try {
                const result = await this.actor.getUnlockedLevels();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async unlockNextLevel(arg0: LevelState): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unlockNextLevel(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
